...
public protocol UserDataSourceProtocol { // TODO: return값 수정
    ...
    func fetchUserInfo(_ userInfo: String) -> Observable<Result<EmptyEntity, WBNetworkError>>
...
public final class UserDataSource: UserDataSourceProtocol {
    ...
    public func fetchUserInfo(_ userInfo: String) -> Observable<Result<EmptyEntity, WBNetworkError>> {
        provider.rx
