...
//        case .style: StyleViewController(StyleViewModel(closetDataSource: NewClosetDataSource()))
        case .style: NewStyleVC(NewStyleViewModel(closetDataSource: NewClosetDataSource()))
